...
4. Re-run the bulkloader tool again this time by passing the configuration file as input:
 appcfg.py download_data --config_file=bulkloader.yaml --kind=dataObject  --filename=readingsMinazi.csv  --url=http://eqdatalogger2.appspot.com/_ah/remote_api

 appcfg.py download_data --config_file=bulkloader.yaml --kind=FileObject  --filename=logMinazi.csv  --url=http://eqdatalogger2.appspot.com/_ah/remote_api